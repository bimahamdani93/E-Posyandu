<?php
require 'actions/function_pembelian.php';
...
if (isset($_POST['submit'])) {
    ...
    if (tambah($_POST) == true) {
        echo "<script>
                    ...
                    window.location.href = ('../pages/layoutdashboard.php?url=form-pembelian');
                </script>";
    } else {
        echo "<script>
...
<body>
    <div class="w-full p-8 z-40 bg-white items-center rounded-md">
        <div class="flex items-center justify-start pt-4 mb-6 pb-4 bg-cyan-200">
            <p class="font-bold dark:text-white text-xl mx-auto">Beli Barang</p>
        </div>
