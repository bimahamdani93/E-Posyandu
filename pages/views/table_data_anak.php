...
$sql = "SELECT * FROM tb_anak INNER JOIN register ON register.id_user = tb_anak.id_user 
WHERE tb_anak.id_user = $_SESSION[id_user]";
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <p>
                                <a href="?url=ubah-data-anak&id=<?= $data['id_anak']; ?>"
                                    class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                    <i class="fas fa-edit"></i>
                                </a>
                            </p>
                            <p>
                                <a href="actions/hapus_anak.php?id=<?= $data['id_anak']; ?>"
