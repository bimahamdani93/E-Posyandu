                        ...
                        <form action="auth/login/act_login.php?op=in" method="POST" class="max-w-sm p-10 m-auto bg-white bg-opacity-25 rounded shadow-xl">
                            ...
                            <div class="flex flex-col mb-2">
                                <div class="flex relative ">
                                    ...
                                    <input type="password" name="psw" class="rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="Your password" />
                                </div>
                            </div>
